...
import ujjawalPortrait from "@/public/ujjawalpotrait.jpg";
...
export default function Intro() {
  ...
  return (
    ...
    >
      ...
      >
        <span className="font-bold">Hello👋 I'm Ujjawal,</span> a{" "}
        <span className="font-bold">Software Engineer.</span> With a strong
        foundation in tech, I am now aspiring to transition into{" "}
        <span className="italic">Product Management</span>.
      </motion.h1>
      ...
      >
        ...
        <div className="flex flex-row sm:flex-row items-center justify-center gap-2 px-4 text-lg font-medium">
          <a
            ...
            href="https://www.linkedin.com/in/ujjawal-kumar-13x11/?profileId=ACoAAEU4SogBr4ipJBVtFoKCRoeCCTdUpPMU_9U"
            target="_blank"
          >
            <BsLinkedin />
          </a>
          ...
          <a
            ...
            href="https://github.com/ujwl-kmr"
            target="_blank"
          >
            <BsGithub />
          </a>
          ...
          <a
            className="bg-white p-4 text-gray-700 flex items-center gap-2 text-[1.35rem] rounded-full focus:scale-[1.15] hover:scale-[1.15] hover:text-gray-950 transition cursor-pointer borderBlack dark:bg-white/10 dark:text-white/60"
            href="https://www.instagram.com/ujwl_kmr_13/"
            target="_blank"
          >
            <BsInstagram />
          </a>
